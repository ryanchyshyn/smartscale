...
def preprocess_for_train(image, height, width, bbox,
  ...
  with tf.name_scope(scope, 'distort_image', [image, height, width, bbox]):
    ...
    distorted_image, distorted_bbox = distorted_bounding_box_crop(image, bbox, area_range=(0.5, 1.0))
    ...
    distorted_image = rotate_and_crop(distorted_image, height, width, random.randint(0, 360), True)
